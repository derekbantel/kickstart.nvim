...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {
      ensure_installed = { 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'vim', 'vimdoc', 'python', 'javascript', 'elixir' },
      auto_install = true,
      highlight = {
        enable = true,
      },
  ...
  require('custom.plugins.xml_formatter').setup(),
  require('custom.plugins.ai_chat').setup(),
}, {
  ui = {
